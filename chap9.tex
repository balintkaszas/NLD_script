...
\notebookbox{
\begin{notebook}
\href{https://drive.google.com/file/d/1bQVw6-qkEDpnvflnTZoSz6tJOSdYeWxN/view?usp=sharing}{Example with a normally hyperbolic invariant manifold.}
\end{notebook}
}
...
\notebookbox{
\begin{notebook}
\href{https://drive.google.com/file/d/1FOb6OHkR0WsN0wjFwN-H7pNtweY38LMa/view?usp=sharing}{Geometry of the phase space of the slowly forced pendulum.}
\end{notebook}
}
...
\notebookbox{
\begin{notebook}
\href{https://drive.google.com/file/d/1it0ehD2sLyVcaSOwfp-Ynm5x8o7M1DNg/view?usp=sharing}{Constructing the slow manifold of Stommel's model.}
\end{notebook}
}
